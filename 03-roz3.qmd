...
Do oceny jakości stanu wód, wykorzystano dane teledetekcyjne w postaci zdjęć satelitarnych.
[@tbl-data_info] zawiera informacje o wykorzystanych danych.
Wszystkie obrazy pochodzą z programu Landsat Collection 2 poziomu drugiego, dla którego zdjęcia zostały poddane korekcji atmosferycznej.
W zależności od lat prowadzonych badań, zdjęcia pochodzą z satelit Landsat 5, 7 lub 8.
Obrazy pozyskano z katalogu Planetary Computer od Microsoft [@microsoft_open_source_2022_7261897].
...
Tabela zawiera również informacje o ilości dostępnych zdjęć dla obszarów badań, pozyskanych z Planetary Computer.
...
Przy dużym zachmurzeniu, ilość dostępnych pikseli dla zbiorników wodnych malała, co skutkowało zmniejszeniem przydatności takiego zdjęcia do badań.
...
Dane o batymetrii udostępnione są w formie rastrów o rozdzielczości 15 sekund kątowych.
Każdy piksel rastra zawiera informacje o głębokości w metrach.
Dane o batymetrii zostały wykorzystane do zbadania zmian wskaźników jakości wód wzdłuż profilów, biegnących od nowych lądów wgłąb zbiorników wodnych.
Pozwoliło to nie tylko na ocenę zmiany jakości wód wraz ze zwiększaniem odległości od lądu, ale również wraz ze zwiększaniem głębokości.
...
knitr::kable(aois, format = "latex", booktabs = TRUE, linesep = "", col.names = c("obszar badań", "satelita", "okres badań", "dostępne zdjęcia", "wybrane zdjęcia", "długość profilu"))  |> 
