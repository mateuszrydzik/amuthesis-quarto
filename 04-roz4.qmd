...
Badania przeprowadzono na pięciu obszarach, położonych na trzech kontynentach.
[@fig-aois] przedstawia położenie przestrzenne obszarów badań.
...
Najwcześniejszy projekt miał miejsce w Singapurze, który rozpoczęto w 1995 roku.
Najnowsze prace, w Kostaryce i Nigerii, zakończono w 2018 roku.
...
#| label: tbl-aois_info
#| echo: false
#| tbl-cap: "Podstawowe informacje o obszarach badań, okresach prowadzenia prac, wielkościach pozyskanych powierzchni i ich wykorzystaniu."
aois <- data.frame(
...
#| label: fig-db_aoi
#| echo: false
#| fig-cap: "Hotel Atlantis, jeden z atrakcji Dubaju, znajduje się na sztucznej wyspie Palm Jumeirah. (Źródło: ckilger/flickr)"
#| out-width: "100%"
...
Cały czas mają miejsce prace nad budową infrastruktury, budynków mieszkalnych i innych niezbędnych obiektów do funkcjonowania Eko Atlantic.
Eko Atlantic ma pełnić rolę nowego miasta oraz centrum biznesowego, w którym mogłoby mieszkać 250 tysięcy mieszkańców [@omotosho2013new].
...
Kostaryka posiada mocną pozycję na rynku eksportowym, będąc liderem na świecie w ilości eksportowanych ananasów, oraz zajmując czwarte miejsce w ilości eksportowanych bananów [@notteboom2022port].
...
Prace ukończono w 2019 roku, oddając do użytku terminal kontenerowy Moin o powierzchni 0.4 kilometra kwadratowego (@fig-cr_aoi).
...
Projekt ten obejmował rozbudowę lotniska Changi o dodatkowe 30 kilometrów kwadratowych powierzchni (@fig-sp_aoi).
...
Od 1990 do 2000 roku, populacja Szanghaju wzrosła z 8,6 do 14,2 milionów osób [@desaunited].
...
Prace nad konstrukcją Nanhui New City rozpoczęto w 2003 roku, planując zakończenie w 2020 roku.
...
Mimo, iż prace w Nanhui New City trwały do 2020 roku, nowy ląd został zbudowany już w 2006 roku, a w 2010 roku dzielnicę zamieszkiwało blisko 200 tysięcy osób [@shi2016new].
